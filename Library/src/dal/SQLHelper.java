...
public class SQLHelper {
    /**
     * public static Connection getConnection() 函数加载并注册数据库驱动，获取数据库连接 返回Connection对象
     * public static Statement getStatement()  通过Connection对象获取Statement对象 返回Statement对象
     * public static Statement getStatement(Connection conn)带参数的函数，返回值与上面的函数相同
     ...
     * public static int ExecSql(String cmdText)  执行SQL语句，参数为SQL语句，返回值非负数为正常
    ...
    /**
     * 驱动 Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");//(1)注册数据库驱动
     */
    ...
    public static PreparedStatement getPreparedStatement(String cmdText, Object... cmdParams) {
        ...
        try {
            ...
            {
                System.out.println("cmdParams["+j+"]=="+cmdParams[j]);
                pstmt.setObject(j+1, cmdParams[j]);
                System.out.println("222cmdParams["+j+"]=="+cmdParams[j]);
     ...
     *
     * @param cmdText   需要 ? 参数的 SQL 语句
     * @param param SQL 语句的参数表
     * @return 非负数:正常执行; -1:执行错误; -2:连接错误
     */
    public static boolean ExecSql(String cmdText, Object... param) {

        //PreparedStatement ps = getPreparedStatement(cmdText, param);
